...
class TestF15UserCreate(TestCase):
    ...
    def test_duplicate_login_id_shows_error(self):
        ...
        User.objects.create_user(login_id='dup@example.com', name='既存', password='Pass123')
        response = self.client.post(self.url, self._valid_post(login_id='dup@example.com'))
